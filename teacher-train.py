...
parser.add_argument('--data', type=str, default='/nfs9/mx/datasets')
parser.add_argument('--output_dir', type=str, default='/nfs9/mx/models')
...
if args.dataset == 'EMNIST':
    ...
    data_train = EMNIST(args.data,
                        split='byclass',
                        train=True,
                        download=True,
                        transform=transform_train)
    data_test = EMNIST(args.data,
                       split='byclass',
                       train=False,
                       transform=transform_test)
